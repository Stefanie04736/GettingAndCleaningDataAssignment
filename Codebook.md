...
* activity
   ...
   Performed activity. Its values are:
    * LAYING
    * SITTING
    * STANDING
    * WALKING
...
* tGravityAccmeanY
   ...
   The mean of the variable tGravityAcc-mean()-Y in the original data source.
...
* tGravityAccstdZ
   ...
   The mean of the variable tGravityAcc-std()-Z in the original data source.
